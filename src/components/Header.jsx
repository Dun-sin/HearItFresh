  ...
  return (
    <div className='bg-brand flex items-center justify-between p-6 text-white min-h-[5%]'>
      <div className='flex flex-col'>
        <h1 className='text-2xl mb-[-6px] text-fmd flex items-center logo'>HearItFresh<Icon icon="material-symbols:music-note-rounded" width="20" height="20" inline={true} /></h1>
        <p className='text-fsm font-light'>Discover Fresh Tracks that Fit Your Style</p>
      </div>

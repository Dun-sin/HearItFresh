...
function OpenOnSpotify({ provider = 'spotify' }: { provider?: ProviderName }) {
	const [openPlaylist, setOpenPlaylist] = useState(false);
	const { playListData } = useGeneralState();

	const meta = PROVIDER_META[provider] ?? PROVIDER_META.spotify;
				...
				<div className={`flex items-center justify-between`}>
					<div className='flex gap-1 items-center'>
						...
						<a
							...
							<span className={`text-fsm md:text-fxs`}>{meta.label}</span>
